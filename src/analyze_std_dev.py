...
data = {
    'LSTM': recorded_data["lstm"]["stdev"],
    'N-BEATS': recorded_data["nbeats"]["stdev"],
    'TFT': recorded_data["tft"]["stdev"],
    'NHITS': recorded_data["nhits"]["stdev"],
    'DLinear': recorded_data["dlinear"]["stdev"],
    'NLinear': recorded_data["nlinear"]["stdev"],
    'TSMixer': recorded_data["tsmixer"]["stdev"]
}
...
custom_colors = ["#c0c0c0", "#1f77b4", "#c0c0c0", "#c0c0c0", "#1f77b4", "#c0c0c0", "#1f77b4", "#800080", "#D3D3D3", "#00FFFF"]

# Create the bar chart
#bars = ax.bar(models, means, color=custom_colors[:len(models)], alpha=0.8)

bars = ax.bar(means.index, means.values/3600.0, capsize=5, color=custom_colors[:7], alpha=0.8)
#bars = ax.bar(means.index, means.values, yerr=stds.values, capsize=5, color='#1f77b4', alpha=0.8)
...
#ax.set_title('Standard Deviation of the forecasted models', fontsize=16)
#ax.set_xlabel('Model', fontsize=18)
ax.set_ylabel('Std. Dev. (hour)', fontsize=18)
